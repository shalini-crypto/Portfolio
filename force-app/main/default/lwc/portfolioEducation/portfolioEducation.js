...
export default class PortfolioEducation extends LightningElement {
    ...
    @wire(getRelatedListRecords, {
        ...
        fields:['Education__c.InstitutionName__c','Education__c.Title__c','Education__c.Passing_Year__c'],
    ...
    formatData(data){
        this.tableData = [...data.records].reverse().map(item=>{
            let Id = item.id
            const {InstitutionName__c, Passing_Year__c, Title__c} = item.fields

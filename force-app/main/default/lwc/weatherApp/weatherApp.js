...
import getWeatherAppDetails from '@salesforce/apex/weatherAppController.getWeatherAppDetails'
export default class WeatherApp extends LightningElement {
  ...
  fetchData(){
    ...
    getWeatherAppDetails({input:this.cityName}).then(result=>{
    ...
    //below this is client side calling
